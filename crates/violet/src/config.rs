...
pub struct RuleThresholds {
  ...
  /// Maximum allowed no-duh comments per function
  #[serde(default = "default_max_no_duh_comments")]
  pub max_no_duh_comments: usize,
}
...
fn default_max_no_duh_comments() -> usize {
  2
}
...
impl Default for RuleThresholds {
  fn default() -> Self {
    Self {
      ...
      max_no_duh_comments: default_max_no_duh_comments(),
    }
  }
}
