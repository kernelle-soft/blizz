...
mod edge_case_tests {
    ...
    fn test_search_insights_case_sensitivity() -> Result<()> {
        ...
        search_insights("Keyword", None, true, false)?;
        
        // Case insensitive search (default)
        search_insights("keyword", None, false, false)?;
    ...
    fn test_search_insights_overview_only() -> Result<()> {
        ...
        search_insights("Overview", None, false, true)?;
        
        // This should not match since we're only searching overview
        search_insights("Details", None, false, true)?;
    ...
    fn test_unicode_content() -> Result<()> {
        ...
        add_insight("unicode_topic", "unicode_name", "Overview with émojis 🚀", "Details with 中文 characters")?;
    ...
    fn test_search_no_results() -> Result<()> {
        ...
        search_insights("nonexistent_term_xyz", None, false, false)?;
    ...
    fn test_update_nonexistent_files() -> Result<()> {
        ...
        let result = update_insight("nonexistent_topic", "nonexistent_name", Some("new overview"), None);
    ...
    fn test_link_insight_error_cases() -> Result<()> {
        ...
        let result = link_insight("source_topic", "source_name", "nonexistent_target", Some("nonexistent_name"));
