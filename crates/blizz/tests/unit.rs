...
mod insight_tests {
    ...
    fn test_get_topics_with_data() -> Result<()> {
        ...
        let insight1 = Insight::new("alpha".to_string(), "test1".to_string(), "O1".to_string(), "D1".to_string());
        let insight2 = Insight::new("beta".to_string(), "test2".to_string(), "O2".to_string(), "D2".to_string());
        let insight3 = Insight::new("alpha".to_string(), "test3".to_string(), "O3".to_string(), "D3".to_string());
    ...
    fn test_get_insights_all() -> Result<()> {
        ...
        let insight1 = Insight::new("topic1".to_string(), "insight1".to_string(), "O1".to_string(), "D1".to_string());
        let insight2 = Insight::new("topic1".to_string(), "insight2".to_string(), "O2".to_string(), "D2".to_string());
        let insight3 = Insight::new("topic2".to_string(), "insight3".to_string(), "O3".to_string(), "D3".to_string());
    ...
    fn test_get_insights_filtered() -> Result<()> {
        ...
        let insight1 = Insight::new("filter_topic".to_string(), "insight1".to_string(), "O1".to_string(), "D1".to_string());
        let insight2 = Insight::new("other_topic".to_string(), "insight2".to_string(), "O2".to_string(), "D2".to_string());
