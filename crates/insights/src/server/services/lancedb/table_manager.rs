...
fn prepare_record_batch_iterator(record: &InsightRecord) -> Result<RecordBatchIterator<std::vec::IntoIter<Result<arrow::record_batch::RecordBatch, arrow::error::ArrowError>>>> {
