...
mod edge_case_tests {
  ...
  fn test_very_long_content() -> Result<()> {
    ...
    add_insight_with_client(&long_topic, &long_name, &long_overview, &long_details)?;
  ...
  fn test_unicode_handling() -> Result<()> {
    ...
    add_insight_with_client(unicode_topic, unicode_name, unicode_overview, unicode_details)?;
  ...
  fn test_special_characters_in_names() -> Result<()> {
    ...
    for (topic, name) in special_cases {
      add_insight_with_client(topic, name, "Test overview", "Test details")?;
  ...
  fn test_malformed_yaml_handling() -> Result<()> {
    ...
    add_insight_with_client("yaml_test", "valid", "Valid overview", "Valid details")?;
  ...
  fn test_simultaneous_operations() -> Result<()> {
    ...
    add_insight_with_client("multi", "test1", "Overview 1", "Details 1")?;
    add_insight_with_client("multi", "test2", "Overview 2", "Details 2")?;
    add_insight_with_client("multi", "test3", "Overview 3", "Details 3")?;

    // Update one while others exist
    update_insight_with_client("multi", "test2", Some("Updated overview"), None)?;
  ...
  fn test_directory_creation() -> Result<()> {
    ...
    add_insight_with_client("new_topic", "new_insight", "New overview", "New details")?;
  ...
  fn test_update_with_no_changes() -> Result<()> {
    ...
    add_insight_with_client("update_test", "unchanged", "Original", "Original details")?;

    // Attempt update with no changes should fail
    let result = update_insight_with_client("update_test", "unchanged", None, None);
  ...
  fn test_delete_without_force() -> Result<()> {
    ...
    add_insight_with_client("delete_test", "protected", "Protected", "Should not be deleted")?;
  ...
  fn test_content_with_frontmatter_separators() -> Result<()> {
    ...
    add_insight_with_client("tricky", "separators", tricky_overview, tricky_details)?;
  ...
  fn test_multiline_content_preservation() -> Result<()> {
    ...
    add_insight_with_client("multiline", "test", multiline_overview, multiline_details)?;
  ...
  fn test_whitespace_handling() -> Result<()> {
    ...
    add_insight_with_client("whitespace", "test", whitespace_overview, whitespace_details)?;
  ...
  fn test_case_sensitivity() -> Result<()> {
    ...
    add_insight_with_client("CaseSensitive", "TestName", "Overview", "Details")?;
  ...
  fn test_numeric_content() -> Result<()> {
    ...
    add_insight_with_client("123", "456", "789", "101112")?;
